            ...
            <form method="POST" action="<?= url('/customers/' . (int) $customer['id']) ?>" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="address" name="address" rows="3"
                              class="mt-1 block w-full rounded-md text-sm border <?= has_error('address') ? 'border-red-500' : 'border-gray-300 dark:border-gray-600' ?> bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:border-indigo-500 focus:ring-indigo-500"><?= e(old('address', $customer['address'])) ?></textarea>
