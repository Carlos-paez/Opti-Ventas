                    ...
                    <?php if (!$customers): ?>
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                ...
                                <a href="<?= url('/customers/create') ?>" class="mt-3 inline-flex items-center text-sm text-indigo-600 hover:text-indigo-800 font-medium">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-sm font-medium text-gray-900"><?= e($customer['name']) ?></span>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600"><?= e($customer['email'] ?: '—') ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600"><?= e($customer['phone'] ?: '—') ?></td>
                            <td class="px-6 py-4 text-sm text-gray-600 max-w-[200px] truncate"><?= e($customer['address'] ?: '—') ?></td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="<?= url('/customers/' . (int) $customer['id'] . '/edit') ?>" class="text-indigo-600 hover:text-indigo-900 font-medium">Editar</a>
