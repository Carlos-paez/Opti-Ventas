        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 mb-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="sku" name="sku" value="<?= e(old('sku')) ?>"
                ...
                <div>
                    ...
                    <input type="text" id="barcode" name="barcode" value="<?= e(old('barcode')) ?>"
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea id="description" name="description" rows="3"
                              ...
                              placeholder="Descripción del producto"><?= e(old('description')) ?></textarea>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="price" name="price" value="<?= e(old('price')) ?>" step="0.01" min="0" required
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-1/2 -translate-y-1/2 text-sm text-gray-400">$</span>
                        <input type="number" id="cost" name="cost" value="<?= e(old('cost')) ?>" step="0.01" min="0"
                ...
                <div>
                    ...
                    <input type="number" id="stock" name="stock" value="<?= e(old('stock', 0)) ?>" min="0" required
                ...
                <div>
                    ...
                    <input type="number" id="stock_min" name="stock_min" value="<?= e(old('stock_min', 5)) ?>" min="0"
